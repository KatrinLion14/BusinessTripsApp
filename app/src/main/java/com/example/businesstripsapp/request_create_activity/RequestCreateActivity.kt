package com.example.businesstripsapp.request_create_activity
...
class RequestCreateActivity : ElmActivity<Event, Effect, State>(R.layout.activity_request_create) {
