 ...
 * Use the [OutgoingRequestsFragment.newInstance] factory method to
...
class OutgoingRequestsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OutgoingRequestsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OutgoingRequestsFragment().apply {
