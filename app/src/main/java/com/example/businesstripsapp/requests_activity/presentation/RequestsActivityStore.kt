...
import com.example.businesstripsapp.requests_activity.domain.RequestRepository
...
class MyActor : Actor<Command, Event> {
    ...
    private val requestRepository : RequestRepository = RequestRepository(NetworkService.instance.getAuthService())
