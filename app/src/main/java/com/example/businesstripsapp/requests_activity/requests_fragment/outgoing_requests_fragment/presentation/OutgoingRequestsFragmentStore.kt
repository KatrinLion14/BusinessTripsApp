package com.example.businesstripsapp.requests_activity.requests_fragment.outgoing_requests_fragment.presentation
...
import com.example.businesstripsapp.requests_activity.requests_fragment.outgoing_requests_fragment.domain.OutgoingRequestRepository
...
class MyActor : Actor<Command, Event> {
    ...
    private val requestRepository : OutgoingRequestRepository = OutgoingRequestRepository(
