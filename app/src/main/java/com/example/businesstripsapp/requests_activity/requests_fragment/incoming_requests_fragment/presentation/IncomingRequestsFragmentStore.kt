package com.example.businesstripsapp.requests_activity.requests_fragment.incoming_requests_fragment.presentation

import com.example.businesstripsapp.requests_activity.requests_fragment.incoming_requests_fragment.domain.IncomingRequestRepository
...
class MyActor : Actor<Command, Event> {
    ...
    private val requestRepository : IncomingRequestRepository = IncomingRequestRepository(NetworkService.instance.getAuthService())
